...
$teamidmem = $rowteam['team_id'];
		...
		/*----------------------------------------------------------------------------------------------------------------*/
				...
				$counter = 0;
				while($rowemission = mysql_fetch_array( $resultemission )) {
						$emmtemp1 +=  $rowemission['member_emmision'];
						$noemission = 1;
						}
						echo $emmtemp1 + $mytotalx.'mT';	
						$finalmytotal = $emmtemp1 + $mytotalx;	
						
						}
						else
						{
						$noemission = 0;
						$finalmytotal = $rowemission['member_emmision'] + $mytotalx;	
						echo $rowemission['member_emmision'] + $mytotalx.'mT';	
