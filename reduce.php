...
?>
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
			...
			echo '
    			<h1 class="entry-title" style = "font-size: 24px;">Carbon Reduction Calculator<font size="3"> (<em>For a metric version of this calculator click <a href="reduce-metric.php" target="_top"><font size="3" color="#00CC00">here</font></a>.</em>)</font></h1><br/><br/>';
			?>
 ...
 function inputChar(val,chk, adto, mult,dte){
  ...
  $(document).ready(function() {
		...
		<table border="1" width="850px" align="center">
			...
			<tr>
				<td><input type="checkbox" name="home" value="43" onclick="getVal(this, 'home_computer_amt','home_computer_date')"> Plug computer into a power strip and turn off when not in use<sup>2</sup></td>
			...
			<tr>
				<td><input type="checkbox" name="home" value="240" onclick="getVal(this, 'home_entertain_eq_amt','home_entertain_eq_date')"> Ditto for home entertainment equipment<sup>2</sup></td>
			...
			<tr>
				<td><input type="checkbox" name="home" value="300" onclick="getVal(this, 'home_no_tv_amt','home_no_tv_date')"> Choose not to own a TV<sup><font style="font-weight:bold">15</font></sup></td>
			...
			<tr>
				<td><input type="checkbox" name="home" value="500" onclick="getVal(this, 'home_new_energystar_fridge_amt','home_new_energystar_fridge_date')"> Replace a pre-2001 refrigerator with an Energy Star model<sup>2</sup></td>
			...
			<tr>
				<td><input type="checkbox" name="home" value="700" onclick="getVal(this, 'home_fridge_maint_amt','home_fridge_maint_date')"> Check refrigerator door seals, clean coils, defrost, keep top clear<sup>2</sup></td>
			...
			<tr>
				<td><input type="checkbox" name="home"  value="800" onclick="getVal(this, 'home_seal_air_leaks_amt','home_seal_air_leaks_date')"> Thoroughly seal air leaks in your home<sup>8</sup></td>
			...
			<tr>
				<td><input type="checkbox" name="home" value="500" onclick="getVal(this, 'home_new_energystar_washer_amt','home_new_energystar_washer_date')"> Replace a washing machine with an Energy Star front load washer<sup>8</sup></td>
				<td><div style="text-align:center;font-weight:bold">500</div></td>	
			...
			<tr>
				<td><input type="checkbox" name="home" value="700" onclick="getVal(this, 'home_use_clothesline_amt','home_use_clothesline_date')"> Use a clothesline instead of a dryer for 6 months/year<sup>9</sup></td>
				<td><div style="text-align:center;font-weight:bold">700</div></td>	
			...
			<tr>
				<td><input type="checkbox" name="home" value="175" onclick="getVal(this, 'home_clean_ac_filter_amt','home_clean_ac_filter_date')"> Clean a dirty air conditioner unit filter<sup>10</sup></td>
			...
			<tr>
				<td><input type="checkbox" name="home" value="2155" onclick="getVal(this, 'home_use_no_ac_amt','home_use_no_ac_date')"> Choose not to own an air conditioner<sup>15</sup></td>
			...
			<tr>
				<td><input type="checkbox" name="home" value="100" onclick="getVal(this, 'home_dishw_energy_saving_amt','home_dishw_energy_saving_date')"> Only run dishwasher when full and use energy-saving setting<sup>9</sup></td>
			...
			<tr>
				<td><input type="checkbox" name="home" value="125" onclick="getVal(this, 'home_replace_dishw_amt','home_replace_dishw_date')"> Replace a pre-2001 dishwasher with an Energy Star model<sup>8</sup></td>
			...
			<tr>
				<td><input type="checkbox" name="home" value="242" onclick="getVal(this, 'home_ac_to_74_amt','home_ac_to_74_date')"> Raise air conditioner thermostat to 74<sup>o</sup>F from 72<sup>o</sup>F<sup>2</sup></td>
			...
			<tr>
				<td><input type="checkbox" name="home" value="484" onclick="getVal(this, 'home_ac_to_76_amt','home_ac_to_76_date')"> Raise air conditioner thermostat to 76<sup>o</sup>F from 72<sup>o</sup>F<sup>2</sup></td>
			...
			<tr>
				<td><input type="checkbox" name="home" value="120" onclick="getVal(this, 'home_push_lawnmower_amt','home_push_lawnmower_date')"> Replace gas lawnmower with a manual push mower<sup>6</sup></td>
			...
			<tr>
				<td><input type="checkbox" name="home" value="100" onclick="getVal(this, 'home_rake_lawn_amt','home_rake_lawn_date')"> Rake a one acre lawn instead of using a leaf blower<sup>6</sup></td>
				<td><div style="text-align:center;font-weight:bold">100</div></td>
			...
			<tr>
				<td>
					<input type="checkbox" id="home_replace_incand_w_cfl_checkbox" name="home_replace_incand_w_cfl_checkbox"  value="55" onclick="getVal2(this, 'home_replace_incand_w_cfl_amt', 'home_replace_incand_w_cfl_var','home_replace_incand_w_cfl_date')">Replace # 75w incand. bulbs w/ 19w CFLs<sup>2</sup>
					<font style="font-weight:bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#:<input type="text" style="text-align:center" name="home_replace_incand_w_cfl_var" id="home_replace_incand_w_cfl_var" size="4" onkeyup="inputChar(55,'home_replace_incand_w_cfl_checkbox','home_replace_incand_w_cfl_amt', 'home_replace_incand_w_cfl_var','home_replace_incand_w_cfl_date')" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;X</font>
				</td>
			...
			<tr>
				<td>
					<input type="checkbox" name="home_purchase_100kW_rec_checkbox" id="home_purchase_100kW_rec_checkbox" value="200" onclick="getVal2(this, 'home_purchase_100kW_rec_amt', 'home_purchase_100kW_rec_var','home_purchase_100kW_rec_date')"> Purchase # 100kWh or &rsquo;&rsquo;Green Electricity&rsquo;&rsquo;<sup>2</sup>
					<font style="font-weight:bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#:<input type="text" style="text-align:center" name="home_purchase_100kW_rec_var" id="home_purchase_100kW_rec_var" size="4" onkeyup="inputChar(200,'home_purchase_100kW_rec_checkbox','home_purchase_100kW_rec_amt', 'home_purchase_100kW_rec_var','home_purchase_100kW_rec_date')" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;X</font>
				</td>
			...
			<tr>
				<td>
					<input type="checkbox" name="home_reduce_showers_checkbox" id="home_reduce_showers_checkbox" value="171" onclick="getVal2(this, 'home_reduce_showers_amt', 'home_reduce_showers_var','home_reduce_showers_date')"> Reduce showers by # minutes for one year<sup>2</sup>
					<font style="font-weight:bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#:<input type="text" style="text-align:center" name="home_reduce_showers_var" id="home_reduce_showers_var" size="4" onkeyup="inputChar(171,'home_reduce_showers_checkbox','home_reduce_showers_amt', 'home_reduce_showers_var','home_reduce_showers_date')" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;X</font>
				</td>
			...
			<tr>
				<td>
					<input type="checkbox" name="home_plant_trees_checkbox" id="home_plant_trees_checkbox" value="25" onclick="getVal2(this, 'home_plant_trees_amt', 'home_plant_trees_var','home_plant_trees_date')"> Plant # trees<sup>8</sup>
					<font style="font-weight:bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#:<input type="text" style="text-align:center" name="home_plant_trees_var" id="home_plant_trees_var" size="4" onkeyup="inputChar(25,'home_plant_trees_checkbox','home_plant_trees_amt', 'home_plant_trees_var','home_plant_trees_date')" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;X</font>
				</td>
	...
	document.getElementById(rad).focus();	
		...
		<table border="1" width="850px" align="center">
			...
			<tr>
				...
				<td><div style="text-align:left;font-weight:bold"><input type="radio" onclick="getVal3('a','home_wash_clothes_cold_w_amt','home_wash_clothes_cold_w_date')" value="250" name="a" id="a"> 250</div></td>
				<td><div style="text-align:left;font-weight:bold"><input type="radio" onclick="getVal3('b','home_wash_clothes_cold_w_amt','home_wash_clothes_cold_w_date')" value="110" name="a" id="b"> 110</div></td>
			...
			<tr>
				...
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="225" id="c" name="b" onclick="getVal3('c','home_low_flow_showerhead_amt','home_low_flow_showerhead_date')"> 225</div></td>
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="100" id="d" name="b" onclick="getVal3('d','home_low_flow_showerhead_amt','home_low_flow_showerhead_date')"> 100</div></td>
			...
			<tr>
				...
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="240" id="e" name="c" onclick="getVal3('e','home_hot_water_to_130_amt','home_hot_water_to_130_date')"> 240</div></td>
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="106" id="f" name="c" onclick="getVal3('f','home_hot_water_to_130_amt','home_hot_water_to_130_date')"> 106</div></td>
			...
			<tr>
				...
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="480" id="g" name="d" onclick="getVal3('g','home_hot_water_to_120_amt','home_hot_water_to_120_date')"> 480</div></td>
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="212" id="h" name="d" onclick="getVal3('h','home_hot_water_to_120_amt','home_hot_water_to_120_date')"> 212</div></td>
			...
			<tr>
				...
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="472" id="i" name="e" onclick="getVal3('i','home_thermostat_to_68_amt','home_thermostat_to_68_date')"> 472</div></td>
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="640" id="j" name="e" onclick="getVal3('j','home_thermostat_to_68_amt','home_thermostat_to_68_date')"> 640</div></td>
			...
			<tr>
				...
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="944" id="k" name="f" onclick="getVal3('k','home_thermostat_to_66_amt','home_thermostat_to_66_date')"> 944</div></td>
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="1280" id="l" name="f" onclick="getVal3('l','home_thermostat_to_66_amt','home_thermostat_to_66_date')"> 1280</div></td>
			...
			<tr>
				...
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="1100" id="m" name="g" onclick="getVal3('m','home_wrap_water_heater_amt','home_wrap_water_heater_date')"> 1100</div></td>
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="220" id="n" name="g" onclick="getVal3('n','home_wrap_water_heater_amt','home_wrap_water_heater_date')"> 220</div></td>
			...
			<tr>
				...
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="472" id="o" name="h" onclick="getVal3('o','home_weatherstrip_amt','home_weatherstrip_date')"> 472</div></td>
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="639" id="p" name="h" onclick="getVal3('p','home_weatherstrip_amt','home_weatherstrip_date')"> 639</div></td>
			...
			<tr>
				...
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="4430" id="q" name="i" onclick="getVal3('q','home_insultate_attic_amt','home_insultate_attic_date')"> 4430</div></td>
				<td><div style="text-align:left;font-weight:bold"><input type="radio" value="1390" id="r" name="i" onclick="getVal3('r','home_insultate_attic_amt','home_insultate_attic_date')"> 1390</div></td>
		...
		<table border="1" width="850px" align="center">
			...
			<tr>
				<td><input type="checkbox" name="waste_reuse_plastic_bags_checkbox" id="waste_reuse_plastic_bags_checkbox" value="23" onclick="getVal2(this, 'waste_reuse_plastic_bags_amt', 'waste_reuse_plastic_bags_var','waste_reuse_plastic_bags_date')"> Reduce/re-use # plastic bags/week<sup>3</sup></td>
				<td><input type="text" style="text-align:center" name="waste_reuse_plastic_bags_var" id="waste_reuse_plastic_bags_var" size="10" onkeyup="inputChar(23,'waste_reuse_plastic_bags_checkbox','waste_reuse_plastic_bags_amt', 'waste_reuse_plastic_bags_var','waste_reuse_plastic_bags_date')" value=""></td>
			...
			<tr>
				<td><input type="checkbox" name="waste_reuse_plastic_bottles_checkbox" id="waste_reuse_plastic_bottles_checkbox" value="57" onclick="getVal2(this, 'waste_reuse_plastic_bottles_amt', 'waste_reuse_plastic_bottles_var','waste_reuse_plastic_bottles_date')"> Reduce/re-use # plastic bottles/week<sup>3</sup></td>
				<td><input type="text" style="text-align:center" name="waste_reuse_plastic_bottles_var" id="waste_reuse_plastic_bottles_var" size="10" value="" onkeyup="inputChar(57,'waste_reuse_plastic_bottles_checkbox','waste_reuse_plastic_bottles_amt', 'waste_reuse_plastic_bottles_var','waste_reuse_plastic_bottles_date')"></td>
				<td><div style="text-align:center;font-weight:bold"><font size="4">X</font></div></td>
			...
			<tr>
				<td><input type="checkbox" name="waste_reuse_alum_cans_checkbox" id="waste_reuse_alum_cans_checkbox" value="18" onclick="getVal2(this, 'waste_reuse_alum_cans_amt', 'waste_reuse_alum_cans_var','waste_reuse_alum_cans_date')"> Reduce/re-use # aluminum cans/week<sup>7</sup></td>
				<td><input type="text" style="text-align:center" name="waste_reuse_alum_cans_var" id="waste_reuse_alum_cans_var" size="10" value="" onkeyup="inputChar(18,'waste_reuse_alum_cans_checkbox','waste_reuse_alum_cans_amt', 'waste_reuse_alum_cans_var','waste_reuse_alum_cans_date')"></td>
				<td><div style="text-align:center;font-weight:bold"><font size="4">X</font></div></td>
			...
			<tr>
				<td><input type="checkbox" name="waste_reuse_glass_bottles_checkbox" id="waste_reuse_glass_bottles_checkbox" value="16" onclick="getVal2(this, 'waste_reuse_glass_bottles_amt', 'waste_reuse_glass_bottles_var','waste_reuse_glass_bottles_date')"> Reduce/re-use # glass bottles/week<sup>7</sup></td>
				<td><input type="text" style="text-align:center" name="waste_reuse_glass_bottles_var" id="waste_reuse_glass_bottles_var" size="10" value="" onkeyup="inputChar(16,'waste_reuse_glass_bottles_checkbox','waste_reuse_glass_bottles_amt', 'waste_reuse_glass_bottles_var','waste_reuse_glass_bottles_date')"></td>
				<td><div style="text-align:center;font-weight:bold"><font size="4">X</font></div></td>
			...
			<tr>
				<td><input type="checkbox" name="waste_recycle_paper_checkbox" id="waste_recycle_paper_checkbox" value="10" onclick="getVal2(this, 'waste_recycle_paper_amt', 'waste_recycle_paper_var','waste_recycle_paper_date')"> Recycle # lbs paper/week<sup>7</sup></td>
				<td><input type="text" style="text-align:center" name="waste_recycle_paper_var" id="waste_recycle_paper_var" size="10" value="" onkeyup="inputChar(10,'waste_recycle_paper_checkbox','waste_recycle_paper_amt', 'waste_recycle_paper_var','waste_recycle_paper_date')"></td>
				<td><div style="text-align:center;font-weight:bold"><font size="4">X</font></div></td>
			...
			<tr>
				<td><input type="checkbox" name="waste" value="17" onclick="getVal(this, 'waste_bring_own_bags_amt','waste_bring_own_bags_date')"> Bring your own shopping bags to the grocery store<sup>13</sup></td>
				<td></td>
				<td></td>
			...
			<tr>
				<td><input type="checkbox" name="waste" value="92" onclick="getVal(this, 'waste_get_off_junk_mail_amt','waste_get_off_junk_mail_date')"> Take yourself off junk mailing lists<sup>14</sup></td>
				<td></td>
				<td></td>
		...
		<table border="1" width="850px" align="center">
			...
			<tr>
				<td><input type="checkbox" name="trans_carpool_checkbox" id="trans_carpool_checkbox" value="800" onclick="getVal2(this, 'trans_carpool_amt', 'trans_carpool_var','trans_carpool_date')"> Carpool # days/week<sup>9</sup></td>
				<td><input type="text" style="text-align:center" name="trans_carpool_var" id="trans_carpool_var" size="16" onkeyup="inputChar(800,'trans_carpool_checkbox','trans_carpool_amt', 'trans_carpool_var','trans_carpool_date')"></td>
				<td><div style="text-align:center;font-weight:bold"><font size="4">X</font></div></td>
				<td><div style="text-align:center;font-weight:bold">800</div></td>
			...
			<tr>
				<td><input type="checkbox" name="trans_fly_less_miles_checkbox" id="trans_fly_less_miles_checkbox" value="0.9" onclick="getVal2(this, 'trans_fly_less_miles_amt', 'trans_fly_less_miles_var','trans_fly_less_miles_date')"> Fly # fewer miles<sup>3</sup></td>
				<td><input type="text" style="text-align:center" name="trans_fly_less_miles_var" id="trans_fly_less_miles_var" size="16" onkeyup="inputChar(0.9,'trans_fly_less_miles_checkbox','trans_fly_less_miles_amt', 'trans_fly_less_miles_var','trans_fly_less_miles_date')"></td>
				<td><div style="text-align:center;font-weight:bold"><font size="4">X</font></div></td>
			...
			<tr>
				<td><input type="checkbox" name="trans_better_mpg_car_checkbox" id="trans_better_mpg_car_checkbox"  value="83" onclick="getVal2(this, 'trans_better_mpg_car_amt', 'trans_better_mpg_car_var','trans_better_mpg_car_date')">  Drive # fewer miles/week<sup>7</sup></td>
				<td><input type="text" style="text-align:center" name="trans_better_mpg_car_var" id="trans_better_mpg_car_var" size="16" onkeyup="inputChar(83,'trans_better_mpg_car_checkbox','trans_better_mpg_car_amt', 'trans_better_mpg_car_var','trans_better_mpg_car_date')"></td>
				<td><div style="text-align:center;font-weight:bold"><font size="4">X</font></div></td>
   ...
   function inputChar10(val,chk, adto, temp1, temp2,dte){
 	if(document.getElementById(temp1).value=='' || document.getElementById(temp2).value==''){
		...
		document.getElementById(temp2).focus();
				...
				<td><input type="checkbox" name="trans_drive_less_miles_checkbox" id="trans_drive_less_miles_checkbox" value="1248" onclick="getVal10(this, 'trans_drive_less_miles_var', 'tmp1', 'tmp2','trans_drive_less_miles_date')"> Buy a car with # better mpg than current car<sup>5</sup></td>
				<!-- Note: Here value for #: input is tmp1 divided by tmp2 = trans_drive_less_miles_var-->
				<td><input type="text" style="text-align:center" name="tmp1" id="tmp1" size="2" onkeyup="inputChar10(1248,'trans_drive_less_miles_checkbox','trans_drive_less_miles_var', 'tmp1', 'tmp2','trans_drive_less_miles_date')"><font style="font-size:10px">mi</font>&nbsp;/&nbsp;&nbsp;<input type="text" style="text-align:center" name="tmp2" id="tmp2" size="2" onkeyup="inputChar10(1248,'trans_drive_less_miles_checkbox','trans_drive_less_miles_var', 'tmp1', 'tmp2','trans_drive_less_miles_date')"><font style="font-size:10px" >mpg</font></td>
				<td><div style="text-align:center;font-weight:bold"><font size="4">X</font></div></td>
			...
			<tr>
				<td><input type="checkbox" name="trans" value="205" onclick="getVal(this, 'trans_train_instead_of_flight_amt','trans_train_instead_of_flight_date')"> For a 500 mile flight, take the train instead<sup>2</sup></td>
				<td></td>
				<td></td>
			...
			<tr>
				<td><input type="checkbox" name="trans" value="900" onclick="getVal(this, 'trans_tun_up_car_amt','trans_tun_up_car_date')"> Tune up your car<sup>7</sup></td>
				<td></td>
				<td></td>
			...
			<tr>
				<td><input type="checkbox" name="trans" value="250" onclick="getVal(this, 'trans_car_adeq_tire_press_amt','trans_car_adeq_tire_press_date')"> Maintain adequate tire pressure (usually around 32 psi)<sup>7</sup></td>
				<td></td>
				<td></td>
			...
			<tr>
				<td><input type="checkbox" name="trans" value="500" onclick="getVal(this, 'trans_car_max_tire_press_amt','trans_car_max_tire_press_date')"> Maintain maximum tire pressure (usually around 35 psi)<sup>7</sup></td>
				<td></td>
				<td></td>
				<td><div style="text-align:center;font-weight:bold">500</div></td>
 ...
 function inputChar7(val,chk, adto, mult,dte){
 	if(document.getElementById(mult).value==''){
		...
		<table border="1" width="850px" align="center">
			...
			<tr>
				<td><input type="checkbox" name="food_replace_red_meat_checkbox" id="food_replace_red_meat_checkbox" value="950" onclick="getVal2(this, 'food_replace_red_meat_amt', 'food_replace_red_meat_var','food_replace_red_meat_date')"> Replace red meat with fish, eggs, and poultry<sup>2</sup></td>
				<td><input type="text" style="text-align:center" name="food_replace_red_meat_var" id="food_replace_red_meat_var" size="10" value="" onkeyup="inputChar7(950,'food_replace_red_meat_checkbox','food_replace_red_meat_amt', 'food_replace_red_meat_var','food_replace_red_meat_date')"></td>
				<td><div style="text-align:center;font-weight:bold"><font size="4">X</font></div></td>
			...
			<tr>
				<td><input type="checkbox" name="food_meat_to_vegetarian_checkbox" id="food_meat_to_vegetarian_checkbox" value="2156" onclick="getVal2(this, 'food_meat_to_vegetarian_amt', 'food_meat_to_vegetarian_var','food_meat_to_vegetarian_date')"> Move from meat diet to ovo-lacto veg. diet<sup>1</sup></td>
				<td><input type="text" style="text-align:center" name="food_meat_to_vegetarian_var" id="food_meat_to_vegetarian_var" size="10" value="" onkeyup="inputChar7(2156,'food_meat_to_vegetarian_checkbox','food_meat_to_vegetarian_amt', 'food_meat_to_vegetarian_var','food_meat_to_vegetarian_date')"></td>
				<td><div style="text-align:center;font-weight:bold"><font size="4">X</font></div></td>
			...
			<tr>
				<td><input type="checkbox" name="food_vegetarian_to_organic_checkbox" id="food_vegetarian_to_organic_checkbox" value="3124" onclick="getVal2(this, 'food_vegetarian_to_organic_amt', 'food_vegetarian_to_organic_var','food_vegetarian_to_organic_date')"> Move closer to 100% organics as a vegetarian<sup>1</sup></td>
				<td><input type="text" style="text-align:center" name="food_vegetarian_to_organic_var" id="food_vegetarian_to_organic_var" size="10" value="" onkeyup="inputChar7(3124,'food_vegetarian_to_organic_checkbox','food_vegetarian_to_organic_amt', 'food_vegetarian_to_organic_var','food_vegetarian_to_organic_date')"></td>
				<td><div style="text-align:center;font-weight:bold"><font size="4">X</font></div></td>
			...
			<tr>
				<td><input type="checkbox" name="food_vegetarian_to_vegan_checkbox" id="food_vegetarian_to_vegan_checkbox" value="1848" onclick="getVal2(this, 'food_vegetarian_to_vegan_amt', 'food_vegetarian_to_vegan_var','food_vegetarian_to_vegan_date')"> Move from ovo-lacto diet to vegan diet<sup>1</sup></td>
				<td><input type="text" style="text-align:center" name="food_vegetarian_to_vegan_var" id="food_vegetarian_to_vegan_var" size="10" value="" onkeyup="inputChar7(1848,'food_vegetarian_to_vegan_checkbox','food_vegetarian_to_vegan_amt', 'food_vegetarian_to_vegan_var','food_vegetarian_to_vegan_date')"></td>
				<td><div style="text-align:center;font-weight:bold"><font size="4">X</font></div></td>
			...
			<tr>
				<td><input type="checkbox" name="food_vegan_to_organic_checkbox" id="food_vegan_to_organic_checkbox" value="2244" onclick="getVal2(this, 'food_vegan_to_organic_amt', 'food_vegan_to_organic_var','food_vegan_to_organic_date')"> Move closer to 100% organics as a vegan<sup>1</sup></td>
				<td><input type="text" style="text-align:center" name="food_vegan_to_organic_var" id="food_vegan_to_organic_var" size="10" value="" onkeyup="inputChar7(2244,'food_vegan_to_organic_checkbox','food_vegan_to_organic_amt', 'food_vegan_to_organic_var','food_vegan_to_organic_date')"></td>
				<td><div style="text-align:center;font-weight:bold"><font size="4">X</font></div></td>
