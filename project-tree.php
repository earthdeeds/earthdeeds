...
<div class="container">
    <div class="menu nav">
		...
		<ul>
            ...
            <li  class="active-menu"><a href="project-view.php">Projects</a>
			<ul class="dropdown">
			<li><a href="#">Projects sub menu 1</a></li>
			<li><a href="#">Projects sub menu 2</a></li>
			<li><a href="#">Projects sub menu 3</a></li>
			<li><a href="#">Projects sub menu 4</a></li>
			</ul>
			</li>
