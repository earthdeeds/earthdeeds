...
<link rel="stylesheet" type="text/css" href="style-wiser.css">
</head>
		 ...
		 ?>
			...
			echo '<div><img src="'.$profpictemp.'" class="user-profile"/></div>';	
                ...
                <div style="float: right; width: 330px; height: auto; background: #f7f7f7; border:1px solid #d0d0d0; padding: 10px;">
                    <div><span class="style8">This is one of the many organizstions listed on Wiser.org
- a global village of 100,000+ people and organizations
working toward social justice, indigenous rights, and 
environmental stewardship.</span></div>
                </div>
                
                <div class="clear"></div>    
				          <a href="#Bot" style="float: right; clear: both;">Submit a Project Request</a>
			</div>
           ...
           <div style="letter-spacing:1px; background: #fbf5df; border: 1px solid #ddd7c0;padding: 5px;">
            ...
            <br />
            <span class="style32"><?php echo $areaorg; ?> </span>          
            </div> 
            <br />
...
<br />';
			...
			<hr></hr>
			<br />		
			  <div style="letter-spacing:1px;"><span class="style14">If you would like this organiation to submit a project to Earth Deeds to be able receive support, please do so below.</span></div> 
            <div style="letter-spacing:1px;"><span class="style14">We’ll follow up them and let you know when they have submitted a project. <br />
Please type in a short note below explaining why you would like this org to submit a project to Earth Deeds:
</span></div>
            <br />
...
<br />';
            ...
            <div style="text-align: left; margin: 0 0 10px 0;"><input type="submit" class="button2" value="Submit Project Request" name="submit"></div>
