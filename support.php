...
<title>Support : Earth Deeds</title>
...
<div style="margin: 20px 0 0 0;">
        	<div class="box">
        <p>EarthDeeds is in a demo / beta phase and no technical support is officially being offered at this time.</p>

<p>Any technical questions or technical support requests should be addressed to Shanti Gaia at <a href="mailto:shanti@EarthDeeds.com">shanti@EarthDeeds.com </a></p>
      	      <div class="clear"></div>
        </div>
      </div>  
    </div> <!-- End of Content ---------------------------------------------------- -->
